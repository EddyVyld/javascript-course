...
const amdRadeonRx = {
    ...
    imprimirPrecioMxM: function (){
        return `$ ${this.price} MXN`
    },
    // Si lo queremos a dolare 
    imprimirPrecioDolares: function (){
        return `$ ${this.price/20} USD`
    }
}
...
const mouseGamer = {
    ...
    model: "MS-101NB-01",
    imprimirPrecioMxM: function (){
        return `$ ${this.price} MXN`  // Podemos mejor utilizar this para referirse al objeto
    },
    // Si lo queremos a dolare 
    imprimirPrecioDolares: function (){
        return `$ ${this.price/20} USD`
...
const instinctRawBoost = {
  ...
  // En una exportacion por default solamente podemos eportar un elemento a la vez
  // En una exportacion normal podemos hacerlo con varios elementos
  // No podemos utilizar las dos en un elemento 



export { amdRadeonRx, mouseGamer };
